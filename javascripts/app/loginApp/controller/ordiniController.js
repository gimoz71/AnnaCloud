angular.module("loginModule").controller("ordiniController", ["$scope", "loginService", "getOrdiniService", "$location", function($scope, loginService, getOrdiniService, $location) {
